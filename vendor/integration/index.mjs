  ...
  return {
    ...
    hooks: {
      'astro:config:setup': async ({
        ...
        const buildLogger = logger.fork('catalyst');

        const virtualModuleId = 'catalyst:config';
        ...
        updateConfig({
          ...
          vite: {
            plugins: [
              {
                name: 'vite-plugin-catalyst-config',
                resolveId(id) {
        ...
        if (typeof _themeConfig === 'string') {
          ...
          buildLogger.info(`catalyst \`${_themeConfig}\` has been loaded.`);
        } else {
          buildLogger.info(`catalyst config has been loaded.`);
        }
      },
